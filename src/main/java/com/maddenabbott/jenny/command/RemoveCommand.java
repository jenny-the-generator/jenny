...
@Description("When you no longer need any templates in a repository, you can remove it, using the\n"
    + "same name you gave that repository, when you added it. The templates in that repository\n"
